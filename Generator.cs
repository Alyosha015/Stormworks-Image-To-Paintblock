...
namespace ImageToPaintblockConverter {
    class Generator {
        ...
        public static void GenerateVehicle() {
            ...
            int desiredWidthBlocks = Util.ReadNumber("Desired Width (In Blocks): ");
            removeUnnecessaryBlocks = Util.ReadBool("Remove Unnecessary Paintblocks (y/n): ");
            if (removeUnnecessaryBlocks) threshold = Util.ReadNumber("Threshold For Considering Block Of Pixels One Color: ");
